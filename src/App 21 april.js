...
const categoryDescriptions = {
  'Economic Mobility and Growth': `77% of Americans believe the economy benefits powerful interests at their expense. People on the bottom half of the ladder have indeed been losing relative ground for decades. 

  The inital proposals:`,

  'K-12 Education': `Our educational attainment has long been among the worst in the developed world. Since Covid, academic achievement has fallen further. 

  The inital proposals:`,

  'Healthcare': `The US spends 18% of GDP on healthcare. Other developed countries spend 10%. Yet our health is the worst in the developed world. 
We thereby waste at least $2.3 trillion each year; boosting the national debt; shortchanging investments in education, skills training and research; and impeding economic mobility and growth.    

The inital proposals:`,

  'Energy Policy': `Current energy policies are inefficient, economically unsustainable and contradictory, subsidizing both fossil fuels and renewables. One result: Extreme weather keeps increasing, irreparably harming millions of Americans, the economy and the environment. 

  The inital proposals:`,

  'Federal Spending & Debt': `The federal debt exceeds 100 percent of GDP,  is clearly headed higher, and is driven by inefficient healthcare, escalating interest, growing Social Security costs; shrinking tax revenue.

  The US government spends $6 per senior for every $1 on a child under 18; favors consumption over investment; and shortchanges programs that help ordinary citizens earn more and contribute more to the economy.

  The inital proposals:`,

  'Taxes': `The tax code has been heavily politicized in ways that reduce the tax base, distort investment incentives, favor the well-off, and create ever-rising debt. 
    ...
    <>
      {showIntroModal && (
        <div className="fixed inset-0 z-50 bg-black bg-opacity-60 flex items-start justify-center overflow-y-auto min-h-screen pt-10">
          ...
          {introStep === 1 && (
  <>
  <p>The American people and our government are in the greatest turmoil of our lifetimes.</p>
    <p><strong>Yet 96% of us are aligned in feeling that one or more of the following aspirations is critical to our wellbeing.</strong></p>
      <p>Which are important to you?</p>
...
{introStep === 2 && (
  <>
    <p><strong>Why this app:</strong> Congress enacts each law to satisfy some voters, some interest groups and some politicians.</p>
    <p>Current policies thereby contradict one another - allowing our chronic problems to grow worse - while wasting trillions of dollars.</p>
    <p><strong>The Grand Bargain Project</strong>  team therefore distilled ideas from various sources to identify 41 reforms that, when combined, would yield historic progress in all six areas, and at lower cost than current policies.</p>
    <p><strong>Now we need your input.</strong> Our goal is to refine the reforms so that more than 75% of us see the total package as advancing our aspirations further than ever. We can then tell each politician:</p>
    <p><em>To stay in office, you need to make this your top priority.</em></p>
...
{introStep === 3 && (
  <>
    <p><strong>To reach that day soon, we need to know which reforms you feel most strongly about, positively or negatively.</strong></p>
    <p>If some are unclear or don’t concern you, don’t spend time on them. Just click <em><strong>Not Sure</strong></em>.</p>
    <p><strong>Most important:</strong> Our goal is to refine the reforms so that more than 75% of us see the total package as advancing our aspirations further than ever. We can then tell each politician:</p>
    <p>Move this total package forward – <em>or find another career.</em></p>
      ...
      {reflectionStep === 2 && (
        <div>
          <p className="mb-4 text-lg font-medium text-gray-800">
            Each of the 41 reforms above have been around for a decade or more. Congress has enacted none. It is very unlikely to do so now.
            <br /><br />
            To change that situation, 75% or more of voters would need to support the total package. Lawmakers who wanted to keep their seats would have to act.
            <br /><br />
            Weighing the reforms you see as critical versus the rest, how much would you and the causes benefit on balance?
            <br /><br />
            In effect, if you had to choose between this Grand Bargain or the country's current direction, which would it be?
            <br /><br />
          </p>
