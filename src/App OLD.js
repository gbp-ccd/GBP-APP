...
<p className="text-center mb-2">
  ...
  <tr key={key} className="border-t">
    ...
    <button
  className="bg-[#142d95] text-white px-4 py-2 rounded text-sm mt-4"
  onClick={async () => {
...
{introStep === 2 && (
  <>
    ...
    <div className="text-left mt-4">
      <button className="bg-[#142d95] text-white px-4 py-2 rounded text-sm mt-4" onClick={() => setIntroStep(3)}>
        Next
      </button>
    </div>
  </>
...
{introStep === 3 && (
  ...
  <p className="m-0">Significantly advance each American’s aspirations</p>
    ...
    <div className="text-left mt-4">
      <button className="bg-[#142d95] text-white px-4 py-2 rounded text-sm mt-4" onClick={() => setIntroStep(4)}>
        Next
      </button>
    </div>
  </>
...
{introStep === 4 && (
  ...
  <p className="m-0">4. If you approve, join our movement.</p>
    ...
    <div className="text-left">
      <button className="bg-[#142d95] text-white px-4 py-2 rounded text-sm mt-4" onClick={() => setShowIntroModal(false)}>
        Please Begin
        </button>
            </div>
          </>
...
<div className="text-base sm:text-lg text-gray-800 mb-6 text-left border border-gray-300 rounded-xl p-5 sm:p-6 bg-white shadow-sm w-full space-y-2">
  <p>You will see the <strong>6 policy areas</strong> at the bottom of this page, each a different color.</p>

  <div className="space-y-2">
    <p className="font-semibold">By clicking on each bar, you will see:</p>
    <ul className="list-disc list-inside space-y-1 text-gray-700">
      <li>Description of the basic problem</li>
      <li><strong>Overall</strong> description of the Grand Bargain proposals</li>
      <li><em>Description of each proposal</em></li>
      <li>You can rate either: The <strong>overall proposal</strong> OR each <em>individual proposal</em></li>
      <li>There are 5 ratings: From <strong>Critical To Me & Others</strong> to <strong>Hate It</strong></li>
    </ul>
  </div>

  <p className="font-semibold text-[#142d95]">Please rate and focus on proposals that really matter to you.</p>
  <p className="italic">If any strike you as unclear or vague, just click <strong>Not Sure</strong></p>
  <p className="font-semibold">If you change your mind about any rating, go to the top of the page and 'x' that proposal. Then go back to the policy area and re-rate it.</p>
</div>
)}
  ...
  {buckets.map(bucket => (
    ...
    >
      ...
      <div className="space-y-2 max-h-[250px] overflow-y-auto pr-1">
        ...
        className="text-black-400 hover:text-red-500 font-bold"
        title="Remove"
      >
        <X size={20} />
                  </button>
  ...
  <p>Most Congresspeople blame the other party for the country’s ills and offer sound bites as remedies, instead of working together on genuine solutions.</p>
...
<div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded text-base sm:text-lg text-gray-800">
...
<p className="text-base sm:text-lg">
          ...
          <p className="text-base sm:text-lg">
            Do you expect this Congress to offer a better deal?
          </p>

          <p className="text-base sm:text-lg">
            So, which would you prefer: Telling members of Congress to enact this Grand Bargain or letting them decide your future?
          </p>
