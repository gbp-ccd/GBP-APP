...
'Taxes': `THE PROBLEM: Politicians from both parties routinely provide their strongest supporters with tax breaks, which boost the national debt and reward wasteful investments.`,
  ...
  'Federal Spending & Debt': `THE PROBLEM: The federal debt, which now equals 100% of GDP, will reach 120% by 2036. Yet, for decades, most voters have rejected efforts to prevent the debt from growing further. `
...
<p className="text-center mb-2">
  <strong>Join a Movement for an America in which You Can Thrive More than Ever</strong>
</p>
  <p>We the American people seem to grow more divided each year, yet we nearly all share similar aspirations: 96% of us see one or more of these six goals as critical to our own lives:</p>
    <p>
...
{introStep === 2 && (
  <>
    ...
    <p><strong>Our two-party system is in effect working to serve its own interests.</strong></p>
    <div className="text-right mt-4">
...
{introStep === 4 && (
  <>
    <p><strong>So far, 77% of Americans using this App in a recent YouGov survey, preferred this package of reforms over the country’s current direction.</strong></p>
    <p>That 77% far exceeds approval ratings for both political parties combined.</p>
    <p>So that you can see for yourself how much better this Grand Bargain would be for you over the country’s current direction, the next screens will ask you to:</p>
...
<li>5 ways to rate each proposal - from Critical To Me & Others, to Hate It</li>
</ul>
<p><strong>You will then have two options:</strong></p>
<ul className="list-disc list-inside ml-6">
<li>You can classify<span className="bg-blue-100 rounded px-1">all the proposals</span>in each area into one of 5 categories.</li>
<li>Or you can classify <em>each proposal</em> into one of the 5 categories.</li>
</ul>
<p><strong>Please rate and focus on proposals that really matter.</strong></p>
<p><strong>If any strike you as unclear or vague, just click <em>Not Sure</em></strong></p>
</div>
)}
  ...
  <div className="space-y-4 text-lg font-medium text-gray-800 mb-4">
    <p><strong>The reforms that you rated positively have been around for years. Congress has enacted none of them.</strong></p>
    ...
    <p>We would then become the largest bloc of voters in US history. Elected officials would need to move in the direction we ask - or lose their seats.</p>
    <p>So far, 77% of voters using this WebApp have preferred this package over the country’s current direction.</p>
    <p>Do you expect this Congress to offer a better deal? </p>
  <div className="flex gap-4 mb-4">
</div>
    <p>So, which would you prefer: Telling members of Congress to enact this Grand Bargain or letting them decide your future?</p>
...
>
  {isSubmittingQ2 ? 'Submitting...' : 'Congress Decides'}
      ...
      {reflectionStep === 3 && (
        <div>
          <p><strong>If you want Congress to decide our future</strong></p>
          <p className="mb-4 text-lg font-small text-gray-800">
      ...
      {expandedCategories[category] && (
        <>
          ...
          <div className="text-lg text-gray-800 whitespace-pre-line mt-4 mb-6 pl-3 pr-3 pt-4 pb-6 italic bg-blue-100 rounded">
            ...
            {category === 'Taxes' && (<>To generate enough revenue to pay for the benefits in health, education and economic opportunity described in earlier sections, raise taxes on those who can most afford it. <br /><br />Eliminate complexity that invites tax evasion. Make entitlement spending more efficient. Incentivize businesses to invest in assets that will increase productivity, future income – and future tax revenue.</>)}
            {category === 'Federal Spending & Debt' && (<>To avoid failures of the past, in this Grand Bargain: <br /><br />1) The Economic Mobility, Education, Healthcare and Energy proposals would boost productivity and growth.<br /> 2) The Healthcare proposals would reduce costs and increase productivity.<br /> 3) The Tax and Energy proposals would raise revenue and increase efficiency.<br /><br /> <strong>The result: The debt - as a percentage of the overall economy - would steadily decline.</strong> </>)}
