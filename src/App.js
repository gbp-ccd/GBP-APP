...
'Taxes': `THE PROBLEM: Politicians from both parties routinely provide their strongest supporters with tax breaks, which boost the national debt and reward wasteful investments.`,
   ...
   'Federal Spending & Debt': `THE PROBLEM: The US government spends $6 per senior for every $1 on a child under 18; favors consumption over investing in the future; and gives tax breaks to favored interests. This puts the federal debt on track to exceed 120% of GDP by 2035, which would send interest rates soaring and hobble our economy. Yet both political parties have let the problem grow steadily worse for decades.`
...
>
    <div className="space-y-4">
            ...
            <div className="text-base sm:text-lg text-gray-800 whitespace-pre-line mt-4 mb-6 pl-3 pr-3 pt-4 pb-6 italic bg-blue-100 border-l-4 border-blue-400 rounded">
              ...
              {category === 'Federal Spending & Debt' && (<>To keep the debt at or below 100% of GDP, the government needs to boost revenue and/or cut spending by about $800 billion a year. To that end:<br /><br />Our proposal to slash tax deductions for the well-off would provide $300 billion annually<br /> The reforms in the Healthcare section would boost productivity, yielding $200 billion yearly<br />Our proposals to end fossil fuel subsidies and put a price on carbon would yield $200 billion in revenue<br /> The 5% VAT would yield $250 billion yearly<br /><br />The additional $150 billion would pay for the improvements in economic mobility, education and healthcare. <br /></>)}
